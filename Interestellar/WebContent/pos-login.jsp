...
<header class="v-header container">
    ...
    <div class="col-dg-10 col-dm-10 col-10 align-center">
        ...
        <div class="centralDiv ranking-list-item col-dg-6">
          <p class="paragrafo">
            Ola "JogadorX", sua pontuacao maxima atingida foi 999pts, selecione uma dificuldade para jogar novamente. Boa sorte!  
          <p>
        </div>
        ...
        <select class="col-dg-6 col-dm-4 col-10 select-group">
          <option class="select-option" value="facil">Fácil</option>
          <option class="select-option">Médio</option>
          <option class="select-option">Difícil</option>
        </select>
        
        <div>
            <a href="jogo.jsp"><button type="button" class="btn colorBtn2">Jogar</button></a>
        </div>
    </div>
</header>
</body>
